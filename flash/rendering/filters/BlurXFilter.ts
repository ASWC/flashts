...
export class BlurXFilter extends Filter
{
    ...
    constructor(strength, quality, resolution, kernelSize)
    {
        ...
        const vertSrc = BlurYFilter.generateVertBlurSource(kernelSize, true);
        const fragSrc = BlurYFilter.generateVertBlurSource(kernelSize);
    ...
    public apply(filterManager, input, output, clear)
    {
        if (this.firstRun)
        {
            ...
            this.vertexSrc = BlurYFilter.generateVertBlurSource(kernelSize, true);
