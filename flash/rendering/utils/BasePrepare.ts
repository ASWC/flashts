...
{
    public static UPLOADS_PER_FRAME = 4;
    public limiter:any;
    public renderer:any;
    public uploadHookHelper:any;
    public queue:any;
    public uploadHooks:any;
    public addHooks:any;
    public completes:any;
    public delayedTick:any;
    public ticking:any;
    public findText:any;
    public calculateTextStyle:any;
    public findTexture:any;
    public drawText:any;
    public findBaseTexture:any;
    public findMultipleBaseTextures:any;
    public findTextStyle:any;
    ...
    public upload(item, done)
    {
        ...
        if (this.queue.length)
        {
            ...
            {
                this.ticking = true;
                Timer.shared.addOnce(this.tick, this, Constants.UPDATE_PRIORITY.UTILITY);
            }
        }
        else if (done)
        {
     ...
     */
    public registerFindHook(addHook)
    {
        if (addHook)
        {
     ...
     * @return {PIXI.BasePrepare} Instance of plugin for chaining.
     */
    public registerUploadHook(uploadHook)
    {
        if (uploadHook)
        {
    ...
    public add(item)
    {
        ...
        if (item instanceof DisplayObjectContainer)
        {
    ...
    public destroy()
    {
        if (this.ticking)
        {
            Timer.shared.remove(this.tick, this);
        }
        this.ticking = false;
        this.addHooks = null;
     ...
     */
    public static findMultipleBaseTextures(item, queue)
    {
        let result = false;
     ...
     * @return {boolean} if a PIXI.Texture object was found.
     */
    public static findBaseTexture(item, queue)
    {
     ...
     * @return {boolean} if a PIXI.Texture object was found.
     */
    public static findTexture(item, queue)
    {
     ...
     */
    public static drawText(helper, item)
    {
     ...
     * @return {boolean} If item was uploaded.
     */
    public static calculateTextStyle(helper, item)
    {
        if (item instanceof TextStyle)
        {
            const font = item.toFontString();
            TextMetrics.measureFont(<string> font);
            return true;
        }
     ...
     */
    public static findText(item, queue)
    {
        if (item instanceof Text)
        {
     ...
     */
    public static findTextStyle(item, queue)
    {
        if (item instanceof TextStyle)
        {
            if (queue.indexOf(item) === -1)
