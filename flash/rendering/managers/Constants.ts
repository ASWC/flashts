...
export class Constants
{
     ...
     * @type {number}
     */
    public static RAD_TO_DEG = 180 / Math.PI;
     ...
     * @example `image.png`
     */
    public static URL_FILE_EXTENSION = /\.(\w{3,4})(?:$|\?|#)/i;
     ...
     */
    public static DATA_URI = /^\s*data:(?:([\w-]+)\/([\w+.-]+))?(?:;(charset=[\w-]+|base64))?,(.*)/i;
     ...
     */
    public static SVG_SIZE = /<svg[^>]*(?:\s(width|height)=('|")(\d*(?:\.\d+)?)(?:px)?('|"))[^>]*(?:\s(width|height)=('|")(\d*(?:\.\d+)?)(?:px)?('|"))[^>]*>/i; // eslint-disable-line max-len
