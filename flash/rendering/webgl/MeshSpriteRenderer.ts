...
export class MeshSpriteRenderer
{
    /**
     ...
     * @param {PIXI.mesh.Mesh} mesh - the Mesh to render
     */
    public _renderTriangleMesh(mesh)
    {
        // draw triangles!!
     ...
     */
    public _renderDrawTriangle(mesh, index0, index1, index2)
    {
