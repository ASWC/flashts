...
export class MaskManager extends ObjectRenderer
{
    ...
    public scissorRenderTarget:any;
    public enableScissor:any;
    public alphaMaskPool:any;
    public alphaMaskIndex:any;
     ...
     */
    public pushMask(target, maskData)
    {
       /* if (maskData.texture)
        {
     ...
     * @param {PIXI.Sprite|PIXI.Graphics} maskData - The masking data.
     */
    public popMask(target, maskData)
    {
        /*if (maskData.texture)
        {
     ...
     */
    public pushSpriteMask(target, maskData)
    {
     ...
     *
     */
    public popSpriteMask(target = null, maskData = null)
    {
     ...
     * @param {PIXI.Sprite|PIXI.Graphics} maskData - The masking data.
     */
    public pushStencilMask(maskData)
    {
     ...
     *
     */
    public popStencilMask(target = null, maskData = null)
    {
        /*this.renderer.currentRenderer.stop();
     ...
     */
    public pushScissorMask(target, maskData)
    {
     ...
     *
     */
    public popScissorMask(target = null, maskData = null)
    {
        /*this.scissorRenderTarget = null;
        this.scissorData = null;
        this.scissor = false;
