...
export class FilterManager// extends WebGLRenderer
{
    ...
    public pool:any;
    public _screenHeight:any;
    public _screenWidth:any;
    public  managedFilters:any;
    ...
    public get filterStack():any
    {
        return this.filterData;
    }

    public set filterStack(value:any)
    {
     ...
     */
    public pushFilter(target, filters)
    {
     ...
     */
    public applyFilter(filter, input, output, clear)
    {
        ...
        if (!shader)
        {
            ...
            {
                shader = filter.glShaders[this.stageContext.getContextID()] = new GLShader(this.gl, filter.vertexSrc, filter.fragmentSrc);
                this.managedFilters.push(filter);
            }
     ...
     */
    public syncUniforms(shader, filter)
    {
     ...
     */
    public getRenderTarget(clear, resolution)
    {
     ...
     */
    public returnRenderTarget(renderTarget)
    {
     ...
     */
    public calculateScreenSpaceMatrix(outputMatrix)
    {
        const currentState = this.filterData.stack[this.filterData.index];

        return Utils.calculateScreenSpaceMatrix(
            outputMatrix,
     ...
     * @return {PIXI.Matrix} The mapped matrix.
     */
    public calculateNormalizedScreenSpaceMatrix(outputMatrix)
    {
        const currentState = this.filterData.stack[this.filterData.index];

        return Utils.calculateNormalizedScreenSpaceMatrix(
            outputMatrix,
            currentState.sourceFrame,
            currentState.renderTarget.size,
     ...
     * @return {PIXI.Matrix} The mapped matrix.
     */
    public calculateSpriteMatrix(outputMatrix, sprite)
    {
        const currentState = this.filterData.stack[this.filterData.index];

        return Utils.calculateSpriteMatrix(
            outputMatrix,
            currentState.sourceFrame,
            currentState.renderTarget.size,
            sprite
     ...
     *
     */
    public destroy(contextLost = false)
    {
     ...
     * @return {PIXI.RenderTarget} The new render target.
     */
    public getPotRenderTarget(gl, minWidth, minHeight, resolution)
    {
        let key:any = FilterManager.screenKey;
     ...
     */
    public freePotRenderTarget(renderTarget)
    {
...
class FilterState
{
     ...
     *
     */
    public destinationFrame:any;
    public filters:any;
    public target:any;
    public resolution:any;
    public sourceFrame:any;
