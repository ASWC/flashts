...
{
    public static DEFAULT_BORDER_SIZE = 10;
    /**
     ...
     */
    public _origWidth:any;
    public _origHeight:any;
    public _leftWidth:any;
    public _topHeight:any;
    public _bottomHeight:any;
    public _rightWidth:any;
     ...
     *
     */
    public updateHorizontalVertices()
    {
     ...
     */
    public drawSegment(context, textureSource, w, h, x1, y1, x2, y2)
    {
    ...
    public set leftWidth(value) // eslint-disable-line require-jsdoc
    {
    ...
    public set rightWidth(value) // eslint-disable-line require-jsdoc
    {
    ...
    public set topHeight(value) // eslint-disable-line require-jsdoc
    {
    ...
    public set bottomHeight(value) // eslint-disable-line require-jsdoc
    {
