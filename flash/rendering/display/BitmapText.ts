...
export class BitmapText extends DisplayObjectContainer
{
     ...
     */
    public _textWidth:any;
    public _textHeight:any;
    public _glyphs:any;
    public _text:any;
    public _maxLineHeight:any;
    public _font:any;
    public dirty:any;
    public _anchor:any;
    public _maxWidth:any;
    ...
    public set text(value) // eslint-disable-line require-jsdoc
    {
     ...
     */
    public static registerFont(xml, texture)
    {
        const data:any = {};
        const info = xml.getElementsByTagName('info')[0];
        const common = xml.getElementsByTagName('common')[0];
        const fileName = xml.getElementsByTagName('page')[0].getAttribute('file');
        const res = Utils.getResolutionOfUrl(fileName, StageSettings.RESOLUTION);
