...
import { CanvasTinter } from "../webgl/CanvasTinter";

export class TilingSprite extends Bitmap
{
     ...
     */
    public tileTransform:any;
    public _canvasPattern:any;
    public uvTransform:any;
    public uvRespectAnchor:any;
    public tintedTexture:any;
    ...
    public set clampMargin(value) // eslint-disable-line require-jsdoc
    {
    ...
    public set tileScale(value) // eslint-disable-line require-jsdoc
    {
    ...
    public set tilePosition(value) // eslint-disable-line require-jsdoc
    {
    ...
    public _renderCanvas(renderer)
    {
        ...
        if (this._textureID !== this._texture.updateID || this.cachedTint !== this.tint)
        {
            ...
            const tempCanvas = new CanvasRenderTarget(texture.frame.width,
            ...
            else
            {
                tempCanvas.context.drawImage(baseTexture.source,
                    -texture.frame.x * baseTextureResolution, -texture.frame.y * baseTextureResolution);
            }
     ...
     */
    public static from(source, width = null, height = null)
    {
     ...
     */
    public static fromFrame(frameId, width, height)
    {
     ...
     */
    public static fromImage(imageId, crossorigin, scaleMode, width, height)
    {
    ...
    public set width(value) // eslint-disable-line require-jsdoc
    {
        this._width = value;
    }
    ...
    public set height(value) // eslint-disable-line require-jsdoc
    {
        this._height = value;
    }
}