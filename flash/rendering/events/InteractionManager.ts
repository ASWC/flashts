...
export class InteractionManager extends EventDispatcher
{
    ...
    public static MOUSE_POINTER_ID = 1;

    // helpers for hitTest() - only used inside hitTest()
    public static hitTestEvent = {
        target: null,
        data: {
            global: null,
        },
    ...
    public renderer:any;
    public mouse:any;
    public autoPreventDefault:any;
    public cursor:any;
    public resolution:any;
    public interactionFrequency:any;
    public _tempPoint:any;
    public interactionDOMElement:any;
    public activeInteractionData:any;
    public supportsTouchEvents:any;
    public supportsPointerEvents:any;
    public moveWhenInside:any;
    public mouseOverRenderer:any;
    public interactionDataPool:any;
    public eventsAdded:any;
    public cursorStyles:any;
    public currentCursorMode:any;
     ...
     */
    public hitTest(globalPoint, root)
    {
        // clear the target for our hit test
        InteractionManager.hitTestEvent.target = null;
        // assign the global point
        InteractionManager.hitTestEvent.data.global = globalPoint;
        ...
        // run the hit test
        this.processInteractive(InteractionManager.hitTestEvent, root, null, true);
        // return our found object - it'll be null if we didn't hit anything

        return InteractionManager.hitTestEvent.target;
    }
     ...
     */
    public setTargetElement(element, resolution = 1)
    {
        this.removeEvents();
    ...
    public addEvents()
    {
        ...
        Timer.shared.add(this.update, this, Constants.UPDATE_PRIORITY.INTERACTION);
        ...
        if (style)
        {
            switch (typeof style)
            {
                ...
                case 'object':
                    ...
                    Utils.merge_options(this.interactionDOMElement.style, style);
                    break;
            }
        }
     ...
     * @private
     */
    /*public dispatchEvent(displayObject, eventString, eventData)
    {
     ...
     */
    public mapPositionToPoint(point, x, y)
    {
        let rect;
     ...
     */
    public processInteractive(interactionEvent, displayObject, func, hitTest, interactive = null)
    {
     ...
     */
    public onPointerDown(originalEvent)
    {
     ...
     */
    public processPointerDown(interactionEvent, displayObject, hit)
    {
     ...
     */
    public onPointerComplete(originalEvent, cancelled, func)
    {
        const events = this.normalizeToPointerData(originalEvent);
     ...
     * @param {PIXI.Container|PIXI.Sprite|PIXI.extras.TilingSprite} displayObject - The display object that was tested
     */
    public processPointerCancel(interactionEvent, displayObject)
    {
        const data = interactionEvent.data;
     ...
     * @param {boolean} hit - the result of the hit test on the display object
     */
    public processPointerUp(interactionEvent, displayObject, hit)
    {
        const data = interactionEvent.data;
     ...
     */
    public onPointerMove(originalEvent)
    {
        // if we support touch events, then only use those for touch events, not pointer events
        if (this.supportsTouchEvents && originalEvent.pointerType === 'touch') return;
     ...
     * @param {boolean} hit - the result of the hit test on the display object
     */
    public processPointerMove(interactionEvent, displayObject, hit)
    {
        const data = interactionEvent.data;
     ...
     */
    public onPointerOut(originalEvent)
    {
        // if we support touch events, then only use those for touch events, not pointer events
        if (this.supportsTouchEvents && originalEvent.pointerType === 'touch') return;
     ...
     * @param {boolean} hit - the result of the hit test on the display object
     */
    public processPointerOverOut(interactionEvent, displayObject, hit)
    {
        const data = interactionEvent.data;
     ...
     */
    public onPointerOver(originalEvent)
    {
        const events = this.normalizeToPointerData(originalEvent);
     ...
     */
    public getInteractionDataForPointerId(event)
    {
     ...
     */
    public releaseInteractionDataForPointerId(pointerId, data = null)
    {
     ...
     */
    public configureInteractionEventForDOMEvent(interactionEvent, pointerEvent, interactionData)
    {
     ...
     */
    public normalizeToPointerData(event:any)
    {
        ...
        if (this.supportsTouchEvents && event instanceof TouchEvent)
        {
            ...
            {
                const touch:any = event.changedTouches[i];
        ...
        {
            var mouseevent:any = event;
            if (typeof mouseevent.isPrimary === 'undefined') mouseevent.isPrimary = true;
            if (typeof mouseevent.width === 'undefined') mouseevent.width = 1;
            if (typeof mouseevent.height === 'undefined') mouseevent.height = 1;
            if (typeof mouseevent.tiltX === 'undefined') mouseevent.tiltX = 0;
            if (typeof mouseevent.tiltY === 'undefined') mouseevent.tiltY = 0;
            if (typeof mouseevent.pointerType === 'undefined') mouseevent.pointerType = 'mouse';
            if (typeof mouseevent.pointerId === 'undefined') mouseevent.pointerId = InteractionManager.MOUSE_POINTER_ID;
            if (typeof mouseevent.pressure === 'undefined') mouseevent.pressure = 0.5;
            mouseevent.twist = 0;
