...
export class Spritesheet
{
    ...
    public _frames:any;
    public _frameKeys:any;
    public _batchIndex:any;
     ...
     */
    public _updateResolution(resolutionFilename)
    {
     ...
     */
    public _processFrames(initialFrameIndex)
    {
     ...
     */
    public destroy(destroyBase = false)
    {
