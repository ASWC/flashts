...
class TextureMatrix
{
    public  _texture:any;
    public mapCoord:any;
    public uClampFrame:any;
    public uClampOffset:any;
    public _lastTextureID:any;
    public clampOffset:any;
    public clampMargin:any;
    public static tempMat:any = new Matrix();
