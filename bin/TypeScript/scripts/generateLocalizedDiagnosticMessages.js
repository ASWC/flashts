define(["require", "exports", "fs", "path", "xml2js"], function (require, exports, fs, path, xml2js) {
    "use strict";
    ...
    function main() {
         ...
         */
        function getPreferedLocaleName(localeName) {
        ...
        function generateLCGFile() {
            return fs.readFile(diagnosticsMapFilePath, (err, data) => {
                handleError(err);
                writeFile(path.join(outputPath, "enu", "diagnosticMessages.generated.json.lcg"), getLCGFileXML(objectToList(JSON.parse(data.toString()))
