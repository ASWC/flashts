...
var ts;
(function (ts) {
    function editFlat(position, deletedLength, newText, source) {
    ...
    function validateEdit(lineIndex, sourceText, position, deleteLength, insertString) {
...
var q:Point=<Point>p;`;
            ...
            validateEditAtLineCharIndex = (line, char, deleteLength, insertString) => {
...
and grew 1cm per day`;
            ...
            const lineIndex = new ts.server.LineIndex();
            lineIndex.load(lines);
            validateEditAtPosition = (position, deleteLength, insertString) => {
                validateEdit(lineIndex, testContent, position, deleteLength, insertString);
            };
        });
        after(() => {
