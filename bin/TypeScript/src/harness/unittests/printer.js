...
(function (ts) {
    describe("PrinterAPI", () => {
        function makePrintsCorrectly(prefix) {
            return function printsCorrectly(name, options, printCallback) {
                it(name, () => {
                    Harness.Baseline.runBaseline(`printerApi/${prefix}.${name}.js`, () => printCallback(ts.createPrinter(Object.assign({ newLine: ts.NewLineKind.CarriageReturnLineFeed }, options))));
                });
            };
        }
        describe("printFile", () => {
