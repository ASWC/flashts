...
`);
    ...
    function testExtractConstant(caption, text) {
        ts.testExtractSymbol(caption, text, "extractConstant", Diagnostics.Extract_constant);
    }
    function testExtractConstantFailed(caption, text) {
        ts.testExtractSymbolFailed(caption, text, Diagnostics.Extract_constant);
    }
})(ts || (ts = {}));
