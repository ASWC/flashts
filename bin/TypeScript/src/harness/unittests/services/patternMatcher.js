...
describe("PatternMatcher", () => {
    ...
    function verifyBreakIntoCharacterSpans(original, ...parts) {
        assert.deepEqual(parts, breakIntoCharacterSpans(original));
    }
    function verifyBreakIntoWordSpans(original, ...parts) {
