...
(function (ts) {
    ...
    function assertParsed(actual, expected) {
        assert.deepEqual(actual.fileNames, expected.fileNames);
        assert.deepEqual(actual.wildcardDirectories, expected.wildcardDirectories);
        assert.deepEqual(actual.errors, expected.errors);
    }
    function validateMatches(expected, json, host, basePath, existingOptions, configFileName, resolutionStack) {
        {
        ...
        }
        {
            ...
            expected.errors = expected.errors.map((error) => ({
    ...
    function createDiagnosticForConfigFile(json, start, length, diagnosticMessage, arg0) {
        ...
        describe("with literal include list", () => {
            ...
            it("with non .ts file extensions are excluded", () => {
                ...
                const expected = {
                    options: {},
                    errors: [
                        ts.createCompilerDiagnostic(Diagnostics.No_inputs_were_found_in_config_file_0_Specified_include_paths_were_1_and_exclude_paths_were_2, caseInsensitiveTsconfigPath, JSON.stringify(json.include), "[]")
                    ],
                    fileNames: [],
                    wildcardDirectories: {},
                };
        ...
        describe("with wildcard include list", () => {
            ...
            it("exclude paths outside of the project using relative paths", () => {
                ...
                const expected = {
                    options: {},
                    errors: [
                        ts.createCompilerDiagnostic(Diagnostics.No_inputs_were_found_in_config_file_0_Specified_include_paths_were_1_and_exclude_paths_were_2, caseInsensitiveTsconfigPath, JSON.stringify(json.include), JSON.stringify(json.exclude))
                    ],
                    fileNames: [],
                    wildcardDirectories: {}
                };
