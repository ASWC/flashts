...
(function (ts) {
    describe("convertTypeAcquisitionFromJson", () => {
        function assertTypeAcquisition(json, configFileName, expectedResult) {
        ...
        function verifyAcquisition(actualTypeAcquisition, expectedResult) {
        ...
        function verifyErrors(actualErrors, expectedResult, hasLocation) {
        ...
        function assertTypeAcquisitionWithJson(json, configFileName, expectedResult) {
        ...
        function assertTypeAcquisitionWithJsonNode(json, configFileName, expectedResult) {
            ...
            const host = new Utils.MockParseConfigHost("/apath/", true, []);
