...
(function (ts) {
    describe("convertCompilerOptionsFromJson", () => {
        function assertCompilerOptions(json, configFileName, expectedResult) {
        ...
        function assertCompilerOptionsWithJson(json, configFileName, expectedResult) {
        ...
        function assertCompilerOptionsWithJsonNode(json, configFileName, expectedResult) {
