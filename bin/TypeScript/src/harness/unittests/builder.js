...
(function (ts) {
    ...
    function makeAssertChanges(getProgram) {
        const host = { useCaseSensitiveFileNames: ts.returnTrue };
        let builderProgram;
        return fileNames => {
    ...
    function makeAssertChangesWithCancellationToken(getProgram) {
        const host = { useCaseSensitiveFileNames: ts.returnTrue };
        let builderProgram;
        let cancel = false;
        ...
        return (fileNames, cancelAfterEmitLength) => {
            cancel = false;
    ...
    function updateProgramFile(program, fileName, fileContent) {
