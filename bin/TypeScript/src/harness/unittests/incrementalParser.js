...
(function (ts) {
    ...
    function compareTrees(oldText, newText, textChangeRange, expectedReusedElements, oldTree) {
    ...
    function reusedElements(oldNode, newNode) {
    ...
    function deleteCode(source, index, toDelete) {
    ...
    function insertCode(source, index, toInsert) {
