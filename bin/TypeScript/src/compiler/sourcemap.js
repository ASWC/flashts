...
(function (ts) {
    ...
    function createSourceMapWriter(host, writer, compilerOptions = host.getCompilerOptions()) {
        const extendedDiagnostics = compilerOptions.extendedDiagnostics;
        let currentSource;
        let currentSourceText;
        let sourceMapDir; // The directory in which sourcemap will be
        ...
        function initialize(filePath, sourceMapFilePath, sourceFileOrBundle, outputSourceMapDataList) {
            ...
            if (compilerOptions.mapRoot) {
                ...
                if (sourceFileOrBundle.kind === ts.SyntaxKind.SourceFile) { // emitting single module file
        ...
        function setSourceFile(sourceFile) {
            ...
            const source = ts.getRelativePathToDirectoryOrUrl(sourcesDirectoryPath, currentSource.fileName, host.getCurrentDirectory(), host.getCanonicalFileName, 
            /*isAbsolutePathAnUrl*/ true);
        ...
        function getSourceMappingURL() {
            ...
            if (compilerOptions.inlineSourceMap) {
                ...
                const base64SourceMapText = ts.base64encode(ts.sys, getText());
