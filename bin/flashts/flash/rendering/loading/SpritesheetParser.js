define(["require", "exports", "flash/rendering/loading/Resource", "../textures/Spritesheet"], function (require, exports, Resource_1, Spritesheet_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class SpritesheetParser {
        static spritesheetParser(resource, next) {
            const imageResourceName = `${resource.name}_image`;
            // skip if no data, its not json, it isn't spritesheet data, or the image resource already exists
            if (!resource.data
                || resource.type !== Resource_1.Resource.TYPE.JSON
            ...
            resource.add(imageResourceName, resourcePath, loadOptions, function onImageLoad(res) {
                ...
                const spritesheet = new Spritesheet_1.Spritesheet(res.texture.baseTexture, resource.data, resource.url);
                spritesheet.parse(() => {
        ...
        static blobMiddlewareFactory(resource, next) {
            if (!resource.data) {
                next();
                return;
            }
    ...
    SpritesheetParser.Url = window.URL || window['webkitURL'];
    SpritesheetParser._keyStr = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=';
