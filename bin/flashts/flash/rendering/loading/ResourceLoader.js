define(["require", "exports", "./Resource", "flash/events/EventDispatcher"], function (require, exports, Resource_1, EventDispatcher_1) {
    "use strict";
    ...
    class ResourceLoader extends EventDispatcher_1.EventDispatcher {
        constructor(baseUrl = '', concurrency = 10) {
             ...
             * @member {Signal}
             */
            this.onProgress = new Resource_1.MiniSignal();
            /**
             ...
             * @member {Signal}
             */
            this.onError = new Resource_1.MiniSignal();
            /**
             ...
             * @member {Signal}
             */
            this.onLoad = new Resource_1.MiniSignal();
            /**
             ...
             * @member {Signal}
             */
            this.onStart = new Resource_1.MiniSignal();
            /**
             ...
             * @member {Signal}
             */
            this.onComplete = new Resource_1.MiniSignal();
            /**
        ...
        _noop() { }
        _insert(data, insertAtFront, callback, q) {
         ...
         */
        _prepareUrl(url) {
            const parsedUrl = Resource_1.Resource.parseUri(url, { strictMode: true });
            let result;
        ...
        _loadResource(resource, dequeue) {
            ...
            this.eachSeries(this._beforeMiddleware, (fn, next) => {
        ...
        _onLoad(resource) {
            ...
            this.eachSeries(this._afterMiddleware, (fn, next) => {
    ...
    ResourceLoader.MAX_PROGRESS = 100;
    ResourceLoader.rgxExtractUrlHash = /(#[\w-]+)?$/;
