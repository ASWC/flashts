define(["require", "exports", "flash/display/DisplayObjectContainer", "../../geom/Point", "flash/rendering/core/shapes/Polygon", "../textures/Texture", "../managers/Constants", "../math/TextureMatrix", "../webgl/Utils", "flash/rendering/core/StageSettings"], function (require, exports, DisplayObjectContainer_1, Point_1, Polygon_1, Texture_1, Constants_1, TextureMatrix_1, Utils_1, StageSettings_1) {
    "use strict";
    ...
    class Mesh extends DisplayObjectContainer_1.DisplayObjectContainer {
        constructor(texture, vertices = null, uvs = null, indices = null, drawMode = null) {
             ...
             * @private
             */
            this._texture = texture || Texture_1.Texture.EMPTY;
            /**
             * The Uvs of the Mesh
             *
             * @member {Float32Array}
             ...
             * @member {number}
             */
            this.canvasPadding = StageSettings_1.StageSettings.MESH_CANVAS_PADDING;
            /**
             ...
             * @private
             */
            this._uvTransform = new TextureMatrix_1.TextureMatrix(this._texture);
            /**
         ...
         */
        get tint() {
            return Utils_1.Utils.rgb2hex(this.tintRgb);
        }
        set tint(value) {
            this.tintRgb = Utils_1.Utils.hex2rgb(value, this.tintRgb);
        }
    }
    /**
    ...
    Mesh.tempPoint = new Point_1.Point();
