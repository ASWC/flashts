define(["require", "exports", "flash/geom/Rectangle", "../textures/RenderTexture", "../display/CanvasRenderTarget"], function (require, exports, Rectangle_1, RenderTexture_1, CanvasRenderTarget_1) {
    ...
    class WebGLExtract {
        ...
        canvas(target) {
            ...
            if (textureBuffer) {
                ...
                const webglPixels = new Uint8Array(WebGLExtract.BYTES_PER_PIXEL * width * height);
     ...
     */
    WebGLExtract.TEMP_RECT = new Rectangle_1.Rectangle();
    WebGLExtract.BYTES_PER_PIXEL = 4;
    exports.WebGLExtract = WebGLExtract;
});
