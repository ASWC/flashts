define(["require", "exports", "../../geom/Matrix", "../math/GroupD8", "./CanvasTinter", "../managers/Constants"], function (require, exports, Matrix_1, GroupD8_1, CanvasTinter_1, Constants_1) {
    ...
    class CanvasSpriteRenderer {
        ...
        render(sprite) {
            ...
            if (texture.valid) {
                ...
                const smoothingEnabled = texture.baseTexture.scaleMode === Constants_1.Constants.SCALE_MODES.LINEAR;
                ...
                if (texture.rotate) {
                    ...
                    GroupD8_1.GroupD8.matrixAppendRotationInv(wt, texture.rotate, dx, dy);
                ...
                if (sprite.tint !== 0xFFFFFF) {
                    if (sprite.cachedTint !== sprite.tint || sprite.tintedTexture.tintId !== sprite._texture._updateID) {
                        ...
                        sprite.tintedTexture = CanvasTinter_1.CanvasTinter.getTintedTexture(sprite, sprite.tint);
                    }
    ...
    CanvasSpriteRenderer.canvasRenderWorldTransform = new Matrix_1.Matrix();
