define(["require", "exports", "./InteractionData", "./InteractionEvent", "../../geom/Point", "flash/utils/Timer", "../managers/Constants", "../webgl/Utils", "./InteractionTrackingData", "flash/events/EventDispatcher"], function (require, exports, InteractionData_1, InteractionEvent_1, Point_1, Timer_1, Constants_1, Utils_1, InteractionTrackingData_1, EventDispatcher_1) {
    "use strict";
    ...
    class InteractionManager extends EventDispatcher_1.EventDispatcher {
        constructor(renderer, options) {
             ...
             * @member {object}
             */
            this.eventData = new InteractionEvent_1.InteractionEvent();
            /**
        ...
        addEvents() {
            ...
            Timer_1.Timer.shared.add(this.update, this, Constants_1.Constants.UPDATE_PRIORITY.INTERACTION);
            ...
            if (style) {
                switch (typeof style) {
                    ...
                    case 'object':
                        ...
                        Utils_1.Utils.merge_options(this.interactionDOMElement.style, style);
                        break;
                }
            }
         ...
         */
        processInteractive(interactionEvent, displayObject, func, hitTest, interactive = null) {
        ...
        processPointerUp(interactionEvent, displayObject, hit) {
            ...
            if (isMouse) {
                const isRightButton = data.button === 2;
                const flags = InteractionTrackingData_1.InteractionTrackingData.FLAGS;
         ...
         */
        releaseInteractionDataForPointerId(pointerId, data = null) {
        ...
        normalizeToPointerData(event) {
            ...
            // apparently PointerEvent subclasses MouseEvent, so yay
                ...
                if (typeof mouseevent.isPrimary === 'undefined')
                    mouseevent.isPrimary = true;
                if (typeof mouseevent.width === 'undefined')
                    mouseevent.width = 1;
                if (typeof mouseevent.height === 'undefined')
                    mouseevent.height = 1;
                if (typeof mouseevent.tiltX === 'undefined')
                    mouseevent.tiltX = 0;
                if (typeof mouseevent.tiltY === 'undefined')
                    mouseevent.tiltY = 0;
                if (typeof mouseevent.pointerType === 'undefined')
                    mouseevent.pointerType = 'mouse';
                if (typeof mouseevent.pointerId === 'undefined')
                    mouseevent.pointerId = InteractionManager.MOUSE_POINTER_ID;
                if (typeof mouseevent.pressure === 'undefined')
                    mouseevent.pressure = 0.5;
                mouseevent.twist = 0;
    ...
    InteractionManager.hitTestEvent = {
        target: null,
        data: {
            global: null,
        },
