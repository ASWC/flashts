define(["require", "exports", "flash/rendering/managers/Constants"], function (require, exports, Constants_1) {
    "use strict";
    ...
    class CanvasMaskManager {
        ...
        renderGraphicsShape(graphics) {
            ...
            for (let i = 0; i < len; i++) {
                ...
                else if (data.type === Constants_1.Constants.SHAPES.RECT) {
                    context.rect(shape.x, shape.y, shape.width, shape.height);
                    context.closePath();
                }
                else if (data.type === Constants_1.Constants.SHAPES.CIRC) {
                    // TODO - need to be Undefined!
                    context.arc(shape.x, shape.y, shape.radius, 0, 2 * Math.PI);
                    context.closePath();
                }
                else if (data.type === Constants_1.Constants.SHAPES.ELIP) {
