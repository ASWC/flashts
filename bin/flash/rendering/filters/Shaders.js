    ...
    class Shaders {
        static checkMaxIfStatmentsInShader(maxIfs, gl) {
            ...
            if (createTempContext) {
                ...
                tinyCanvas.width = 1;
                tinyCanvas.height = 1;
                gl = Utils_1.Utils.createContext(tinyCanvas);
            }
        ...
        static get TEXTURE() {
            var shader = "precision highp float;" + Shaders.lineBreak;
        ...
        static generateMultiTextureShader(gl, maxTextures) {
            ...
            const shader = new GLShader_1.GLShader(gl, vertexSrc, fragmentSrc);
            const sampleValues = [];
        ...
        static get COLOR_MATRIX() {
            var shader = "varying vec2 vTextureCoord;" + Shaders.lineBreak;
        ...
        static get VERTEX_MASK() {
            var shader = "attribute vec2 aVertexPosition;" + Shaders.lineBreak;
            shader += "attribute vec2 aTextureCoord;" + Shaders.lineBreak;
            shader += "uniform mat3 projectionMatrix;" + Shaders.lineBreak;
        ...
        static get DISPLACEMENT() {
            var shader = "varying vec2 vFilterCoord;" + Shaders.lineBreak;
            shader += "varying vec2 vTextureCoord;" + Shaders.lineBreak;
        ...
        static get FRAGMENT_FXAA() {
            var shader = "varying vec2 v_rgbNW;" + Shaders.lineBreak;
        ...
        static get FRAGMENT_PRIMITIVE() {
            var shader = "precision mediump float;" + Shaders.lineBreak;
            shader += "varying vec4 vColor;" + Shaders.lineBreak;
            shader += "void main(void)" + Shaders.lineBreak;
            shader += "{" + Shaders.lineBreak;
        ...
        static get FRAGMENT_MULTITEXTURE() {
            var shader = "precision mediump float;" + Shaders.lineBreak;
            shader += "varying vec2 vTextureCoord;" + Shaders.lineBreak;
            shader += "varying vec4 vColor;" + Shaders.lineBreak;
            shader += "varying float vTextureId;" + Shaders.lineBreak;
        ...
        static get VERTEX_MULTITEXTURE() {
            var shader = "precision mediump float;" + Shaders.lineBreak;
            shader += "attribute vec2 aVertexPosition;" + Shaders.lineBreak;
            shader += "attribute vec2 aTextureCoord;" + Shaders.lineBreak;
            shader += "attribute vec4 aColor;" + Shaders.lineBreak;
