define(["require", "exports", "flash/display/BaseObject"], function (require, exports, BaseObject_1) {
    ...
    class Texture extends BaseObject_1.BaseObject {
        ...
        uploadData(data, width, height) {
            ...
            if (data instanceof Float32Array) {
                if (!Texture.FLOATING_POINT_AVAILABLE) {
                    var ext = this.gl.getExtension("OES_texture_float");
                    if (ext) {
                        Texture.FLOATING_POINT_AVAILABLE = true;
                    }
                    else {
    ...
    Texture.FLOATING_POINT_AVAILABLE = false;
