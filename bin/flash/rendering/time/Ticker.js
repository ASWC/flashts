define(["require", "exports", "../events/TickerListener", "../managers/Constants", "flash/rendering/core/StageSettings"], function (require, exports, TickerListener_1, Constants_1, StageSettings_1) {
    "use strict";
    ...
    class Ticker {
        ...
        static get shared() {
            if (!Ticker._sharedTicker) {
                Ticker._sharedTicker = new Ticker();
            }
            return Ticker._sharedTicker;
        }
        /**
