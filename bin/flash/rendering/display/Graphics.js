define(["require", "exports", "./Container", "../../geom/Matrix", "../../geom/Point", "../managers/Constants", "../math/Bounds", "../shapes/Polygon", "../shapes/Rectangle", "../shapes/RoundedRectangle", "../shapes/Circle", "../shapes/Ellipse", "flash/display/Sprite", "../textures/Texture", "../webgl/Utils", "../shapes/GraphicsData", "../textures/RenderTexture", "../webgl/CanvasRenderer", "../shapes/ShapeUtils", "flash/rendering/core/renderers/GraphicsRenderer"], function (require, exports, Container_1, Matrix_1, Point_1, Constants_1, Bounds_1, Polygon_1, Rectangle_1, RoundedRectangle_1, Circle_1, Ellipse_1, Sprite_1, Texture_1, Utils_1, GraphicsData_1, RenderTexture_1, CanvasRenderer_1, ShapeUtils_1, GraphicsRenderer_1) {
    "use strict";
    ...
    class Graphics extends Container_1.Container {
        ...
        isFastRect() {
            return this.graphicsData.length === 1
                && this.graphicsData[0].shape.type === Constants_1.Constants.SHAPES.RECT
        ...
        _renderWebGL(renderer) {
            ...
            if (this._fastRect) {
                ...
                renderer.setObjectRenderer(GraphicsRenderer_1.GraphicsRenderer.renderer);
        ...
        _renderSpriteRect(renderer) {
            ...
            if (!this._spriteRect) {
                this._spriteRect = new Sprite_1.Sprite(new Texture_1.Texture(Texture_1.Texture.WHITE));
            }
            ...
            if (this.tint === 0xffffff) {
                ...
                const t1 = Graphics.tempColor1;
                const t2 = Graphics.tempColor2;
                Utils_1.Utils.hex2rgb(this.graphicsData[0].fillColor, t1);
                Utils_1.Utils.hex2rgb(this.tint, t2);
                t1[0] *= t2[0];
                t1[1] *= t2[1];
                t1[2] *= t2[2];
                sprite.tint = Utils_1.Utils.rgb2hex(t1);
            }
        ...
        generateCanvasTexture(scaleMode, resolution = 1) {
            ...
            const canvasBuffer = RenderTexture_1.RenderTexture.create(bounds.width, bounds.height, scaleMode, resolution);
            if (!Graphics.canvasRenderer) {
                Graphics.canvasRenderer = new CanvasRenderer_1.CanvasRenderer();
            }
            this.transform.updateLocalTransform();
            this.transform.localTransform.copy(Graphics.tempMatrix);
            Graphics.tempMatrix.invert();
            Graphics.tempMatrix.tx -= bounds.x;
            Graphics.tempMatrix.ty -= bounds.y;
            Graphics.canvasRenderer.render(this, canvasBuffer, true, Graphics.tempMatrix);
            const texture = Texture_1.Texture.fromCanvas(canvasBuffer.baseTexture._canvasRenderTarget.canvas, scaleMode, 'graphics');
