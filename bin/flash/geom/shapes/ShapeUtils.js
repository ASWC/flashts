define(["require", "exports", "flash/geom/Point", "flash/rendering/managers/Constants"], function (require, exports, Point_1, Constants_1) {
    ...
    // TYPED
    class ShapeUtils {
        static buildRoundedRectangle(webGLData, graphicsData, webGLDataNativeLines) {
        ...
        static earcut(data, holeIndices, dim) {
            ...
            var outerNode = ShapeUtils.linkedList(data, 0, outerLen, dim, true);
            var triangles = [];
            if (!outerNode)
                return triangles;
            var minX = 0;
        ...
        static isEarHashed(ear, minX, minY, invSize) {
            ...
            var maxZ = ShapeUtils.zOrder(maxTX, maxTY, minX, minY, invSize);
            var p = ear.prevZ;
            var n = ear.nextZ;
        ...
        static buildComplexPoly(webGLData, graphicsData) {
        ...
        static buildCircle(webGLData, graphicsData) {
        ...
        static buildRectangle(webGLData, graphicsData) {
        ...
        static buildPoly(webGLData, graphicsData) {
