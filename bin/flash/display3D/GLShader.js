define(["require", "exports", "flash/rendering/webgl/Utils", "flash/display/BaseObject", "flash/display3D/types/DataTypes", "flash/display3D/types/DataTypes", "flash/display3D/types/DataTypes"], function (require, exports, Utils_1, BaseObject_1, DataTypes_1, DataTypes_2, DataTypes_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class GLShader extends BaseObject_1.BaseObject {
        constructor(gl, vertexSrc, fragmentSrc, attributeLocations = null) {
            super();
            this.size = 0;
            this.gl = gl;
        ...
        generateUniformAccessObject(gl, uniformData) {
            var uniforms = new DataTypes_3.ShaderUnniformAccess(gl);
        ...
        getUniformGroup(nameTokens, uniform) {
            for (var i = 0; i < nameTokens.length - 1; i++) {
                var o = uniform[nameTokens[i]] || { data: {} };
        ...
        extractUniforms(gl, program) {
            ...
            for (var i = 0; i < totalUniforms; i++) {
                ...
                uniforms[name] = new DataTypes_2.ShaderUnniformData(type, uniformData.size, gl.getUniformLocation(program, name), Utils_1.Utils.defaultValue(type, uniformData.size));
            }
            return uniforms;
        }
        ;
